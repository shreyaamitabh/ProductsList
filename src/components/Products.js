      ...
      items: [
        {
          id: "0",
          image:
            "https://static.turbosquid.com/Preview/2017/03/01__09_47_53/MilkCarton01.png7330FC04-B8BE-4D21-92F8-B5E1EBCA761FOriginal.jpg",
        ...
        },
        {
          id: "1",
          image:
            "https://5.imimg.com/data5/AO/AP/MY-46895908/britannia-marie-gold-biscuit-500x500.jpg",
        ...
        },
        {
          id: "2",
          image:
            "https://thumbs.dreamstime.com/b/london-uk-march-uncle-ben-s-microwave-classic-long-grain-rice-packet-white-background-140750850.jpg",
        ...
        },
        {
          id: "3",
          image:
            "https://5.imimg.com/data5/VG/AQ/MY-9101930/amul-taaza-toned-milk-500x500.jpg",
        ...
        },
        {
          id: "5",
          image:
            "https://5.imimg.com/data5/RO/MS/MY-20704244/basmati-rice-packaging-bag-500x500.jpg",
...

        {
          id: "6",
          image:
            "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcRQwGR1udE6vYGOz55np5GuxUM5uAnabDLKuOEobSgQOzINLwYM&usqp=CAU",
        ...
        },
        {
          id: "7",
          image:
            "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSHweZkAzUuM2qlgWoT6ToSNLCdagQtVksIKC36earEzDAw5PZ8&usqp=CAU",
  ...
  render() {
    return (
      <Fragment>
        ...
        {!this.state.change || this.state.filter === "" ? (
          <Table
            items={this.state.items}
            action1={this.handleClick}
            action={this.changeQuantity}
          />
        ) : (
          <Table
